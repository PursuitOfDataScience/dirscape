...
│    home        /home/jdoe42               rwx      858M / 30G (3%)   │
│    project     /project/hpc               rwx       11T / no limit   │
...
leaves. Piped or redirected it prints the table above and stops. Counts and teasers are
behind `--summary`.
...
| `dirscape why <path>` | Every probe it ran on one path, in plain sentences |
